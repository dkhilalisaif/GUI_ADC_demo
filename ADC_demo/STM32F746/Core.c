...
static const unsigned int _StringsDefault0[] =
{
  ...
  0x070001D6, 0x030A4D80, 0xC8E9388B, 0x854421D0, 0x04F25513, 0x9B615310, 0xDA150E8E,
  0xCAD390E4, 0x9F4188C3, 0x11C004BA, 0x108647E3, 0x09650A39, 0x994C2A60, 0x88026D34,
  0xCA677390, 0x9E814F86, 0xA2A61A1C, 0x9A1A9B5B, 0xB14895A6, 0x00A2C8ED, 0x43CC5ADA,
  0x8A5D6B31, 0xACCE315F, 0x4E467369, 0x00C71129, 0x23531998, 0xA97DA4C4, 0xD4FBB5A2,
  0x0A8FDB62, 0xFC645A19, 0xC55FE4B4, 0x64471F1F, 0xE5EDD838, 0xF31400D1, 0xA1523C55,
  0x7257B10B, 0x1998441A, 0x7C8892C0, 0xD8CD10A1, 0xBC920015, 0xDEB62D92, 0x4337B58D,
  0x2A4200A3, 0x397168B4, 0x571089C5, 0xB5ABFE76, 0x89354863, 0x78EC6E3D, 0xBF447935,
  0x8C473526, 0x4339DA29, 0x1E31BB33, 0x23A43865, 0xE0001D5E, 0x38BF491F, 0x379B6BEC,
  0x0BE6EF64, 0xC559ED7E, 0x98A4716D, 0xD4312342, 0x696D5096, 0x5676C6B4, 0x49122481,
  0x9FD49800, 0xD7496750, 0xD4714512, 0x0A4CD0A7, 0x08962085, 0x9FC4C5FA, 0x7769E164,
  0x651C4296, 0x7F86A1C8, 0x82DBD821, 0x5A974142, 0x258A1E44, 0x00004056, 0x00000000
};
...
static const XStringRes _Const0005 = { _StringsDefault0, 0x005B };
static const XStringRes _Const0006 = { _StringsDefault0, 0x006C };
static const XColor _Const0007 = { 0x00, 0x00, 0x00, 0x00 };
static const XStringRes _Const0008 = { _StringsDefault0, 0x0086 };
static const XStringRes _Const0009 = { _StringsDefault0, 0x00B9 };
static const XStringRes _Const000A = { _StringsDefault0, 0x0110 };
static const XStringRes _Const000B = { _StringsDefault0, 0x0147 };
...
void CoreSystemEventTask__Init( CoreSystemEventTask _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( CoreSystemEventTask );
...
EW_DEFINE_CLASS( CoreSystemEventTask, CoreTask, context, _None, _None, _None, _None, 
                 _None, "Core::SystemEventTask" )
...
void CoreSystemEvent__Init( CoreSystemEvent _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( CoreSystemEvent );
...
EW_DEFINE_CLASS( CoreSystemEvent, XObject, context, _None, _None, _None, _None, 
                 _None, "Core::SystemEvent" )
...
void CorePropertyObserver__Init( CorePropertyObserver _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( CorePropertyObserver );
...
EW_DEFINE_CLASS( CorePropertyObserver, XObject, OnEvent, OnEvent, Outlet, Enabled, 
                 Enabled, Enabled, "Core::PropertyObserver" )
