...
/* Include a file containing the font resource : 'Resources::FontExtraLarge' */
#include "_ResourcesFontExtraLarge.h"

/* Table with links to derived variants of the font resource : 'Resources::FontExtraLarge' */
EW_RES_WITHOUT_VARIANTS( ResourcesFontExtraLarge )
